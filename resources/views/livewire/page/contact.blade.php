                        ...
                        <div
                            ...
                            @if ($image)
                                <div class="relative">
                                    ...
                                    <button type="button"
                                            class="absolute top-3 right-3 inline-flex items-center justify-center w-9 h-9 rounded-full bg-red-50 text-red-600 hover:bg-red-100 shadow"
                                    ...
                                    <div class="mt-2 text-sm text-green-600 truncate text-left">
                            ...
                            @else
                                <label for="image" class="cursor-pointer">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-sm text-gray-400">PNG, JPG, JPEG, WEBP, GIF tối đa 3MB</p>
                                    </div>
                                </label>
                            @endif
