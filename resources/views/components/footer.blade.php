<footer class="w-full bg-[#824DFF] py-10 px-4 md:px-10 lg:px-24">
    <div class="mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 max-w-screen-xl">
        ...
        <div
            class="col-span-1 md:col-span-6 lg:col-span-6 flex flex-col justify-between items-center md:items-start text-center md:text-left mb-8 md:mb-0">
            <div>
                <h2
            ...
            <div
                class="flex gap-4 mt-2 justify-center md:justify-start items-center md:items-start w-full">
                <a href="#"
        ...
        <!-- Cột giữa: About -->
        <div
            class="col-span-1 md:col-span-3 lg:col-span-2 flex flex-col gap-2 items-center md:items-start text-center md:text-left mb-8 md:mb-0">
            <div class="text-white font-semibold text-lg mb-2">Về OCCO</div>
            <a href="{{ Route::has('privacy') ? route('privacy') : '#' }}" class="text-white/80 hover:text-white transition text-base py-1">Chính sách bảo mật</a>
            <a href="{{ Route::has('service-agreement') ? route('service-agreement') : '#' }}" class="text-white/80 hover:text-white transition text-base py-1">Thỏa thuận dịch vụ</a>
            <a href="{{ Route::has('about') ? route('about') : '#' }}" class="text-white/80 hover:text-white transition text-base py-1">Về chúng tôi</a>
            <a href="{{ Route::has('contact') ? route('contact') : '#' }}" class="text-white/80 hover:text-white transition text-base py-1">Liên hệ</a>
        </div>
